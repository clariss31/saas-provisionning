...
### Lot 6 — Skill `kaleido-provisioning`
- `.claude/skills/kaleido-provisioning/SKILL.md` : procédures + snippets pour les
  appels API Dolibarr (tiers/contrat/statut), règles de slug/unicité, **procédure
  d'injection du module Kaleido dans le gabarit SYS**, déclenchement/diagnostic du
  cron SYS sur la VM 7724. Référence croisée avec le skill `dolibarr-dev`.

### Lot 7 (hors code app, à cadrer côté agence)
