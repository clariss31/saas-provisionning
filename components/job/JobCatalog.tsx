...
const JOBS: Job[] = [
  {
    ...
    modules: ["Agenda", "Tiers", "Devis", "Factures", "Projets"],
    image: freelanceImg,
  },
  {
    slug: "fleuriste",
    ...
    modules: ["Agenda", "Produits", "Stocks", "Caisse", "Factures"],
    image: fleuristeImg,
  },
  {
    slug: "garagiste",
    ...
    modules: ["Agenda", "Produits", "Devis", "Stocks", "Factures"],
    image: garagisteImg,
  },
  {
    slug: "artisan",
    ...
    modules: ["Agenda", "Produits", "Devis", "Interventions", "Projets", "Factures"],
    image: artisanImg,
  },
];
